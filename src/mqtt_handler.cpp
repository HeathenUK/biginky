...
<<<<<<< Updated upstream
                ...
                // Serial.printf("...message: total_len=%d, allocated buffer=%d bytes, retain=%d, topic='%s'\n", 
...
<<<<<<< Updated upstream
            // Serial.printf("...message received: %d bytes\n", mqttMessageBufferUsed);
=======
...
<<<<<<< Updated upstream
                ...
                if ((strcmp(mqttMessageTopic, mqttTopicWebUI) == 0 || strcmp(topic, mqttTopicWebUI) == 0) && message[0] == '{') {
                    ...
                    // Serial.printf("...message (web interface) on topic %s: %d bytes\n", mqttMessageTopic, mqttMessageBufferUsed);
=======
...
>>>>>>> Stashed changes
            ...
            // Process non-retained JSON messages
                ...
                String jsonMessage = String((const char*)mqttMessageBuffer, mqttMessageBufferUsed);
<<<<<<< Updated upstream
                // Serial.printf("...message from web UI: %d bytes\n", mqttMessageBufferUsed);
=======
...
<<<<<<< Updated upstream
                // Serial.printf("...message on topic %s (safety measure)...\n", topicToClear);
                int msg_id = esp_mqtt_client_publish(client, topicToClear, "", 0, 1, 1);
                if (msg_id > 0) {
                    // Serial.printf("...message to clear topic %s (msg_id: %d)\n", topicToClear, msg_id);
                } else {
                    // Serial.printf("...message to clear topic %s (msg_id: %d, client=%p)\n", 
...
void publishMQTTCommandCompletion(const String& commandId, const String& commandName, bool success) {
    ...
    if (written < 0 || written >= (int)jsonSize) {
<<<<<<< Updated upstream
        // Serial.printf("...Command completion JSON buffer too small (needed %d, had %d)\n", written, jsonSize);
=======
