...
// This is optimal for 6-color output - larger LUTs offer no benefit
#define COLOR_LUT_BITS  5
#define COLOR_LUT_SIZE  32   // 2^5
#define COLOR_LUT_TOTAL 32768  // 32^3
#define COLOR_LUT_SHIFT 3    // 8 - 5
